namespace HW_Thermal_Tools.Forms
{
    partial class ShellTempFitting
    {
        ...
        private void InitializeComponent()
        {
            ...
            txtFrontPoint = new TextBox();
            txtFramePoint = new TextBox();
            txtBottomPoint = new TextBox();
            BtnStfConfirm = new Button();
            BtnPictureFront = new Button();
            ...
            // TxtboxStfFilesPath
            // 
            TxtboxNtcnames.SetColumnSpan(TxtboxStfFilesPath, 15);
            ...
            TxtboxStfFilesPath.Size = new Size(534, 82);
        ...
        private Button BtnPictureFront;
