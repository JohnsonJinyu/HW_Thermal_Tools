namespace HW_Thermal_Tools.Forms
{
    partial class keithley2306
    {
        ...
        private void InitializeComponent()
        {
            ...
            DevicesConnetStatuLabel = new ToolStripStatusLabel();
            RadioButton_PowerText_Model = new RadioButton();
            RadioButton_Charge_Model = new RadioButton();
            Btn_Power_Off = new Button();
            Btn_Power_On = new Button();
            DataGridView_CurrentInput = new DataGridView();
            Current = new DataGridViewTextBoxColumn();
            Voltage = new DataGridViewTextBoxColumn();
            Time = new DataGridViewTextBoxColumn();
            Btn_Check_Device = new Button();
            Btn_Save = new Button();
            tableLayoutPanel_Control = new TableLayoutPanel();
            comboBox1 = new ComboBox();
            TextBox_PowerText_Result = new TextBox();
            Btn_Start_Text = new Button();
            Btn_Stop_Text = new Button();
            Btn_Pause_Continue = new Button();
            panel1 = new Panel();
            statusStrip1.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)DataGridView_CurrentInput).BeginInit();
            tableLayoutPanel_Control.SuspendLayout();
            SuspendLayout();
            // 
            // statusStrip1
            // 
